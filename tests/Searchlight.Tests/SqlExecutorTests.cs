...
namespace Searchlight.Tests
{
    ...
    public class SqlExecutorTests
    {
        ...
        public void TooManyParameters()
        {
            ...
            var ex = Assert.ThrowsException<TooManyParametersException>((Action)(() =>
            {
        ...
        public void AllQueryExpressions()
        {
            ...
            Assert.ThrowsException<ParserSyntaxException>(() => s = ParseWhereClause("a REALLYSHOULDBE 'test'"));
            Assert.ThrowsException<ParserSyntaxException>(() => s = ParseWhereClause("a !<= 'test'"));
        }
