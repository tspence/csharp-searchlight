...
namespace Searchlight.Tests.Parsing
{
    public class SqlServerSafeQueryParserTests
    {
        ...
        [TestMethod("Parser.TooManyParameters")]
        public void TooManyParameters()
        {
            ...
            //var ex = Assert.ThrowsException<TooManyParametersException>(() => _parser.ParseWhereClause(originalFilter));
        ...
        public void CaseSensitivity()
        {
            ...
            //var ok = _parser.ParseWhereClause(originalFilter);
            ...
            //ok = _parser.ParseWhereClause(originalFilter);
            //Assert.AreEqual("b BETWEEN @p1 AND @p2", ok.ValidatedFilter);
            //Assert.AreEqual(2, ok.SqlParameters.ParameterNames.Count());
